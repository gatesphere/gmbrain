...
public class NodeWeb implements Serializable
{
	...
	welcomeNode.setDescription
	    ("This is a blank list and a (pretty much) blank node. You can begin by editing this Web or by Loading a pre-existing Web.\n If you are making a new web, use this node as an Introduction or starting node.");
	...
	String xout
	    = "<?xml version=\"1.0\" encoding=\"utf-8\" standalone=\"yes\" ?> <NodeWeb>";
	GMNode tempNode = new GMNode();
	...
	for (int i = 0; i < nodeList.size(); i++) {
	    ...
	    xout += ("<description>" + tempNode.getDescription()
		     + "</description>");
		...
		xout
		    += "<id>" + nodeList.indexOf(temperNode) + "</id> </link>";
	    }
	    xout += "</linklist></node>";
	}
	xout += "</NodeWeb>";
